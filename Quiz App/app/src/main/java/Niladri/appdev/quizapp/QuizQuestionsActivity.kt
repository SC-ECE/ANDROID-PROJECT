package Niladri.appdev.quizapp
...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
   ...
   private var buttonSubmit:Button? = null
    ...
    /**
     * A function to setting the question to UI components.
     */
    private fun setQuestion() {

        val question: Question =
            mQuestionsList!![mCurrentPosition - 1] // Getting the question from the list.
           defaultOptionsView()
